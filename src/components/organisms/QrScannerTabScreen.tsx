...
export function QrScannerTabScreen(props: {
  ...
  return (
    <div className={cn('flex flex-col items-center gap-6 pt-3 pb-28 select-text text-center', props.className)}>
      ...
      <div className="relative w-64 h-64 rounded-[32px] overflow-hidden border-2 border-white/40 shadow-2xl bg-black/40 backdrop-blur-md flex items-center justify-center p-6">
